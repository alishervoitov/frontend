...
import client, { downloadPatientHistoryPdf, downloadAttachment } from "../api/client";
                    ...
                    {records.map((r) => (
                        <div key={r.id} className="timeline-item">
                            ...
                            <div className="timeline-card">
                                ...
                                <RecordAttachments recordId={r.id} isDoctor={isDoctor} />
                            </div>
                        </div>
                    ))}
                </div>
...
function RecordAttachments({ recordId, isDoctor }) {
